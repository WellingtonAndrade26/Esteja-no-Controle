...
(() => {
  ...
  load("./js/card-management.js?v=1.0.13", "enc-card-management");
  load("./js/card-limit-sync.js?v=1.0.13", "enc-card-limit-sync");
  load("./js/ai-complete.js?v=1.0.13", "enc-ai-complete");
  load("./js/benefits.js?v=1.0.13", "enc-benefits");
})();
